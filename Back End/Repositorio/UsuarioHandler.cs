...
namespace ProyectoFinalCoderHouse.ADO.NET
{
    ...
    {
        public static string ConnectionString = "Data Source=SANTIAGO;Initial Catalog=SistemaGestion;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public static bool EliminarUsuario(int id)
        {
            using (SqlConnection sqlConnection = new SqlConnection(ConnectionString))
            {
                using (SqlCommand sqlCommand = new SqlCommand())
                {
                    ...
                    sqlCommand.CommandText = "UPDATE Producto SET IdUsuario = -1 WHERE IdUsuario = @ID";
                    sqlCommand.CommandText = "UPDATE Venta SET IdUsuario = -1 WHERE IdUsuario = @ID";
